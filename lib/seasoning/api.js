        ...
        function _bindValuesToTemplateObject(template) {
          ...
          return {
            ...
            bindParams: function (paramVal) {
              ...
              _.each(paramVal, function (paramPropertyValue, paramPropertyKey) {
                ...
                //opt 2: for string templates
                  ...
                  clonedTemplateObj[paramPropertyKey] = _.merge(tmplPropToBeBound, paramPropertyValue,
                      function (propTemplate, propParam, mergingKey, tmplNode, paramNode) {

                        console.log("//>>>>>>>>>>>> MERGING <<<<<<<<<<<<<<<<");
                        console.log(arguments);

                        if (_.isUndefined(propParam) && _.isUndefined(propTemplate)) {
                          console.log('>>>>>  >> deep object is undefined for ' + tmplPropToBeBound);
                          return undefined;
                        }
        ...
        _.each(endpointObj, function (endpointItemVal, endpointItemKey) {
          ...
          //4. bind misc
            ...
            endpointObj['getUrl'] = function getUrl(urlParams) {
              return path.join(SaltyApiDriver.getConfig().salt.api.apiBaseUrl, rootObj.url, endpointItemVal);
            };
          }
          else {
            //do nothing
